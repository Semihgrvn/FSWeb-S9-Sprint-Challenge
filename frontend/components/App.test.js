...
test("x ve y koordinatları doğru gösteriliyor ", () => {
  render(<AppFunctional />)
...
test("yukarı basınca koordinatları doğru mu", () => {
  render(<AppFunctional />)
...
test("2 kez yukarı basınca hata mesajıı doğru mu", () => {
  render(<AppFunctional />)
...
test("hatalı email girildiğinde hata mesajı veriyor mu", async () => {
  render(<AppFunctional />)
...
test("doğru email girildiğinde başarı mesajı veriyor mu", async () => {
  render(<AppFunctional />)
